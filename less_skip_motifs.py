...
#this script will take the output from the skipping and get motifs for the exons skipped significantly less
...
def main():
    ...
    parser.add_option("-s","--skip-file",action="store",type="string",dest="skip_file",help="skipping results file")
